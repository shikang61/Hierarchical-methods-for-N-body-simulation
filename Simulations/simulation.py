...
def run_FMM_simulation(center, 
        ...
        if direct_sum:
            ...
            # Error
            error = simple_error(phi_fmm, phi_direct)
            FMM_error.append(relative_error(phi_fmm, phi_direct))
...
def run_BH_simulation(center, 
    ...
    if direct_sum:
        ...
        # Error
        BH_error.append(relative_error(phi_bh, phi_direct))
        error = simple_error(phi_bh, phi_direct)
