...
################## UPWARD PASS ##################
def multipole(particles, p, center, time_dic): #S2M
    """
    ...
    end_time = time.perf_counter()
    time_dic["S2M_time"] += end_time - start_time
    return a_k, time_dic
...
def FMM_calculate_potential_all(root):
    ...
    1. S2M: Compute multipole expansion of the potential field due to all particles in each box about the box center at the finest level (leaf box).
